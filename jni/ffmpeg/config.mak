...
CPPFLAGS= --sysroot=/home/roman10/Desktop/android/android-ndk-r5b/platforms/android-8/arch-arm/ -D_ISOC99_SOURCE -D_POSIX_C_SOURCE=200112 -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC
...
CC_O=-o $@
LDFLAGS= -Wl,-rpath-link=/home/roman10/Desktop/android/android-ndk-r5b/platforms/android-8/arch-arm//usr/lib -L/home/roman10/Desktop/android/android-ndk-r5b/platforms/android-8/arch-arm//usr/lib -nostdlib -lc -lm -ldl -llog --sysroot=/home/roman10/Desktop/android/android-ndk-r5b/platforms/android-8/arch-arm/ -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link,$(BUILD_ROOT)/libpostproc -Wl,-rpath-link,$(BUILD_ROOT)/libswscale -Wl,-rpath-link,$(BUILD_ROOT)/libavfilter -Wl,-rpath-link,$(BUILD_ROOT)/libavdevice -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavutil
