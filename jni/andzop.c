...
static void load_gop_info();
static void prepare_decode_of_gop(int _stFrame, int _edFrame, int _roiSh, int _roiSw, int _roiEh, int _roiEw);
...
static void prepare_decode_of_gop(int _stFrame, int _edFrame, int _roiSh, int _roiSw, int _roiEh, int _roiEw) {
    LOGI(10, "prepare decode of gop started");
    gRoiSh = _roiSh;
    gRoiSw = _roiSw;
    gRoiEh = _roiEh;
    gRoiEw = _roiEw;
